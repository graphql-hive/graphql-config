...
The documentation at [the-guild.dev/graphql/config](https://the-guild.dev/graphql/config) is
...
`https://config-pr-<number>.guild-dev-website.pages.dev/graphql/config` (linked in a PR comment
